...
namespace ompl
{
    namespace app
    {
        ...
        protected:
            ...
            Eigen::Vector3d startPosition_{70.0, 35.0, 20.0};
            Eigen::Vector3d goalPosition_{60.0, -15.0, 15.0};
        
            double solveTime = 60 * 60 * 12; 

            double posMaxDelta = 1.0; // Your maximum position step, in meters

            int pos_ref_size = static_cast<int>(std::round(posMaxDelta * 20)); // Size of the acceleration reference trajectory
