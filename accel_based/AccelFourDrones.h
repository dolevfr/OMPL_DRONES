...
namespace ompl
{
    namespace app
    {
        ...
        protected:
            ...
            double solveTime = 60 * 60 * 10; // 10 hours

            int acc_ref_size = 20; // Size of the acceleration reference trajectory

            double accelMaxDelta = 0.001; // or your chosen maximum delta
