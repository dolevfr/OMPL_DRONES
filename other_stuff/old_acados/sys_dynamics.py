...
from common import (
    ...
    payloadInertia,  # 3×3 inertia matrix of payload
    droneInertia,    # 3×3 inertia matrix of a drone
    l,               # cable length
...
class SysDyn:
    ...
    def SetupOde(self):
        ...
        for i in range(self.n_drones):
            ...
            α_d = ca.solve(droneInertia, τ - droneBeta*ω)
        ...
        α_p     = ca.solve(payloadInertia, payload_torque)
