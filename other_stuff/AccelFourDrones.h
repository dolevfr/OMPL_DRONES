...
namespace ompl
{
    namespace app
    {
        ...
        class AccelPayloadSystem : public AppBase<AppType::CONTROL>
        {
        public:
            AccelPayloadSystem();

            ~AccelPayloadSystem() override = default;
            ...
            /** \brief Propagate the system state using the ODE solver */
            void propagateWithAcados(const ompl::base::State *from, const ompl::control::Control *control, ompl::base::State *to);
        ...
        protected:
            ...
            base::StateSpacePtr constructStateSpace();

            static unsigned int droneCount_;          // Number of drones in the system
            
            double n_states = 13 + droneCount_ * 11;
        ...
        private:
            py::object acados_mod_;               // The imported acados Python module
            py::object acados_ocp_;               // The Acados OCP object (Python)
            py::object accel_fun_;                // The CasADi acceleration function (Python)

            std::shared_ptr<ompl::control::ControlSampler> sampler_;

            // std::shared_ptr<ompl::base::CompoundStateSpace> stateSpace_;
